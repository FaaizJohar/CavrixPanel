...
/*
|--------------------------------------------------------------------------
| Theme Studio Controller Routes
|--------------------------------------------------------------------------
|
| Endpoint: /admin/theme-studio
|
*/
Route::group(['prefix' => 'theme-studio'], function () {
    Route::get('/', [Admin\ThemeStudioController::class, 'index'])->name('admin.theme-studio');

    Route::post('/upload', [Admin\ThemeStudioController::class, 'upload'])->name('admin.theme-studio.upload');
    Route::post('/publish', [Admin\ThemeStudioController::class, 'publish'])->name('admin.theme-studio.publish');
    Route::post('/reset', [Admin\ThemeStudioController::class, 'reset'])->name('admin.theme-studio.reset');
});
